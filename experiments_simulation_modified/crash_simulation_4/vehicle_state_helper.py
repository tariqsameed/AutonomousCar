...
def RotationExtraction(striker_precrash_position, striker_collision_point, striker_post_crash_position, victim_precrash_position, victim_collision_point, victim_post_crash_position):
    ...
    # if striker_deviation > 0 and  striker_deviation <= 15:
    #     striker_deviaiton_score = 0.3
    #
    # if striker_deviation > 15 and  striker_deviation <= 30:
    #     striker_deviaiton_score = 0.2
    #
    # if striker_deviation > 30:
    #     striker_deviaiton_score = 0.1
    #
    #
    # #---------------------------------------------------------
    #
    # if victim_deviation > 0 and victim_deviation <= 15:
    #     victim_deviaiton_score = 0.3
    #
    # if victim_deviation > 15 and victim_deviation <= 30:
    #     victim_deviaiton_score = 0.2
    #
    # if victim_deviation > 30:
    #     victim_deviaiton_score = 0.1


    print(striker_deviation_score)
    print(victim_deviation_score)
