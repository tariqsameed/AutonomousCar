...
import random
import numpy as np
from experiments_simulation_modified.crash_simulation_4.crash_simulation_helper import getV1BeamNGCoordinaes, getV2BeamNGCoordinaes
from experiments_simulation_modified.crash_simulation_4.crash_simulation_helper import AngleBtw2Points, getDistance
from experiments_simulation_modified.crash_simulation_4.vehicle_state_helper import DamageExtraction, DistanceExtraction, RotationExtraction
import csv
import sys
...
road_striker = [(203, 125), (202, 156)]
road_victim = [(238, 156), (202, 156)]
...
def generateRandomPopulation(N=5,Gene=10):
    ...
    random_population.append([2, 2, 6, 1, 8, 4, 1, 7, 1, 4, 1, 4, 5, 7])
...
for population in populations:
    ...
    try:
        ...
        for number in range(60):
            ...
            if vehicleStriker.state['pos'][0] > 202 and vehicleStriker.state['pos'][1] > 156:
                # print('free state')
            ...
            # print(vehicleStriker.state['pos'])
            if vehicleVictim.state['pos'][0] > 202 and vehicleVictim.state['pos'][1] > 156:
                # print('free state')
